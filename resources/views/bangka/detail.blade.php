                ...
                <div class="card-body">
                    <table class="table">
                        <tbody>
                            ...
                            <tr><td>Description</td><td>{{ $place->description }}</td></tr>
                            <tr><td>Gambar</td><td><img src="{{ Storage::url('gambar/').$place->image }}" style="width: 200px"></td></tr>
                        </tbody>
                        <td><a href="{{ route('loc_bangka.index') }}" class="btn btn-secondary">Kembali</a></td>
                    </table>
                </div>
            </div>
        </div>

...
<div class="container">
    <div class="row mb-4" style="background: #fff">
        <div class="col-lg-12">
            <a href="{{ url('/') }}">Halaman Map</a> / Kelola Map
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('loc_bangka.create') }}" class="btn btn-primary btn-sm float-right">Add New Place</a>
